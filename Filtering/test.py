"""
Tests for students for the Hybrid images (P1) assignment
...
class TestCrossCorrelation2D(unittest.TestCase):
    ...
    def test_identity_filter_grey(self):
        ...
        identity[1,1] = 1
        img_dup = filtering.cross_correlation_2d(self.small_img_grey, identity)
    ...
    def test_mean_filter_grey(self):
        ...
        '''
        mean = np.ones((3,3))
        student = filtering.cross_correlation_2d(self.small_img_grey, mean)
    ...
    def test_mean_filter_RGB(self):
        ...
        '''
        mean = np.ones((3,3))
        student = filtering.cross_correlation_2d(self.img_rgb, mean)
    ...
    def test_rand_rect_filter_RGB(self):
        ...
        student = filtering.cross_correlation_2d(self.img_rgb, rand_filt)
        solution = cv2.filter2D(self.img_rgb, -1, rand_filt, borderType=cv2.BORDER_CONSTANT)
	print(self.img_rgb[0]);
	print(rand_filt);
	print(student[5]);
	print(solution[5]);
	print(student);
    ...
    def test_big_filter_grey(self):
        ...
        student = filtering.cross_correlation_2d(self.small_img_grey, rand_filter)
...
class TestConvolve2D(unittest.TestCase):
    ...
    def test_identity_filter_grey(self):
        ...
        identity = np.zeros((3,3))
        identity[1,1] = 1
        img_dup = filtering.convolve_2d(self.small_img_grey, identity)
        self.assertTrue(np.allclose(img_dup, self.small_img_grey, atol=1e-08), \
    ...
    def test_mean_filter_grey(self):
        ...
        '''
        mean = np.ones((3,3))
        student = filtering.convolve_2d(self.small_img_grey, mean)
        solution = cv2.filter2D(self.small_img_grey, -1, mean, borderType=cv2.BORDER_CONSTANT)
    ...
    def test_mean_filter_RGB(self):
        ...
        '''
        mean = np.ones((3,3))
        student = filtering.convolve_2d(self.img_rgb, mean)
        solution = cv2.filter2D(self.img_rgb, -1, mean, borderType=cv2.BORDER_CONSTANT)
    ...
    def test_rand_rect_filter_RGB(self):
        ...
        student = filtering.convolve_2d(self.img_rgb, rand_filt)
    ...
    def test_big_filter_grey(self):
        ...
        rand_filt_trans = np.fliplr(np.flipud(rand_filt))
        student = filtering.convolve_2d(self.small_img_grey, rand_filt)
...
class TestGaussianKernel2D(unittest.TestCase):
	...
	#print(filtering.gaussian_blur_kernel_2d(5,5,5));
	#print(a);
        self.assertTrue(np.allclose(filtering.gaussian_blur_kernel_2d(5, 5, 5), a,
            atol=1e-08))
	...
	#print(filtering.gaussian_blur_kernel_2d(1,7,3));
	#print(a);
        self.assertTrue(np.allclose(filtering.gaussian_blur_kernel_2d(1, 7, 3), a,
            atol=1e-08))
    ...
    def test_1079_3_5(self):
        ...
        self.assertTrue(np.allclose(filtering.gaussian_blur_kernel_2d(10.79, 3, 5),
            a, atol=1e-08))
...
class TestHighLowPass(unittest.TestCase):
    ...
    def test_low_pass_2_3(self):
       ...
       [[ 0.30984611,  0.25329434,  0.39856696],
        ...
        self.assertTrue(np.allclose(filtering.low_pass(self.img1, 2, 3),
            r, atol=1e-08))
    ...
    def test_high_pass_2_3(self):
       ...
       [[ 0.43283425,  0.13444749,  0.52570046],
        ...
        self.assertTrue(np.allclose(filtering.high_pass(self.img1, 2, 3),
            r, atol=1e-08))
    ...
    def test_low_pass_9_7(self):
       ...
       [[ 0.17926668,  0.17065694,  0.12255439],
        ...
        self.assertTrue(np.allclose(filtering.low_pass(self.img2, 9, 7), r,
                atol=1e-08))
    ...
    def test_high_pass_9_7(self):
       ...
       [[ 0.05740758,  0.22434804,  0.16188927],
        ...
        self.assertTrue(np.allclose(filtering.high_pass(self.img2, 9, 7), r,
                atol=1e-08))
