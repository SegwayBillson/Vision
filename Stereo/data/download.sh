...
#wget http://vision.middlebury.edu/stereo/data/scenes2014/zip/Backpack-perfect.zip
...
wget http://vision.middlebury.edu/stereo/data/scenes2014/zip/Flowers-perfect.zip --no-check-certificate
